...
object MessageLinks {
  case class TwitterUser(followers: Int,
                         name: String,
  ...
  case class TwitterStatus(name: Option[String],
  ...
  case class Video(thumbnailUrl: Option[String],
                   views: Option[Int],
  ...
  case class Link(description: Option[String],
                  title: Option[String],
...
case class MessageLinks(url: String,
...
case class MessageFmt1(from: Option[JsObject],
                       message_links: Seq[MessageLinks],
                       file: Option[MessageFmt1.File],
                       date: String,
                       mentions: JsArray,
                       message: String,
                       id: String) extends HasMentions with HasFromOpt with Message
 ...
 *    @see https://www.hipchat.com/docs/apiv2/method/get_room_message
 */
case class MessageFmt2(from: Option[String],
                       message_format: MessageFormat,
                       color: Color,
                       date: String,
                       mentions: JsArray,
                       message: String,
                       id: String) extends HasMentions with Message
